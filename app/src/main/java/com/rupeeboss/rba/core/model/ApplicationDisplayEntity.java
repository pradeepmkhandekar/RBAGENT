...
public class ApplicationDisplayEntity implements Parcelable{
        /**
         * AppId : 1533
    ...
    protected ApplicationDisplayEntity (Parcel in){
    ...
    public static final Creator<ApplicationDisplayEntity> CREATOR = new Creator<ApplicationDisplayEntity>() {
        @Override
        public ApplicationDisplayEntity createFromParcel(Parcel source) {
            return new ApplicationDisplayEntity(source);
        }

        @Override
        public ApplicationDisplayEntity[] newArray(int size) {
            return new ApplicationDisplayEntity[size];
        }
    };
}