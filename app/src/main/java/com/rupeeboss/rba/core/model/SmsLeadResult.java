...
public  class SmsLeadResult {
    ...
    public String getEmpCode() {
        ...
        public List<SmsLeadEntity> getLstLeads() {
            return lstLeads;
        }

        public void setLstLeads(List<SmsLeadEntity> lstLeads) {
