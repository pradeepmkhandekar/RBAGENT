...
public  class CustomerApplicationEntity implements Parcelable {
        /**
         * AppId : 4982
         * ApplicantDOB : 08/09/1987
         * ApplicantGender : Male
         * ApplicantIncome : 245000
         * ApplicantNme : null
         * ApplicantObligations :
         * ApplnStatus : Complete
         * ApplntName : Sanajy Shrivastav Shah
         * BrokerId : 0
         * City : THANE
         * CoApplicantDOB :
         ...
         * CoApplicantSource : null
         * CoApplicantTurnover :
         * CoApplicantYes : 0
         * Contact : 9865545450
         * Depreciation :
         * DirectorRemuneration :
         * Email : ajay@insuremagic.com
         * Gross_Income : 0
         * LoanRequired :
         * LoanTenure : 15
         * Loan_Cost :
    ...
    protected CustomerApplicationEntity(Parcel in) {
    ...
    public static final Parcelable.Creator<CustomerApplicationEntity> CREATOR = new Parcelable.Creator<CustomerApplicationEntity>() {
        @Override
        public CustomerApplicationEntity createFromParcel(Parcel source) {
            return new CustomerApplicationEntity(source);
        }

        @Override
        public CustomerApplicationEntity[] newArray(int size) {
            return new CustomerApplicationEntity[size];
        }
    };
}