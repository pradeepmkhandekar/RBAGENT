...
public class MyLeadDetailActivity extends BaseActivity implements IResponseSubcriber {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_lead_detail);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        init_widgets();
        showProgressDialog();
        new MyListController(this).getParentList(new LoginFacade(MyLeadDetailActivity.this).getPanNumber(), 0, this);
    }
