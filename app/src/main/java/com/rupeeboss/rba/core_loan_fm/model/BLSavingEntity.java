...
public class BLSavingEntity implements Parcelable {
        /**
         * amount : 11246.43
         * new_amount : 10993.79
         * drop_emi : 252.63
    ...
    protected BLSavingEntity(Parcel in) {
    ...
    public static final Creator<BLSavingEntity> CREATOR = new Creator<BLSavingEntity>() {
        @Override
        public BLSavingEntity createFromParcel(Parcel in) {
            return new BLSavingEntity(in);
        }

        @Override
        public BLSavingEntity[] newArray(int size) {
            return new BLSavingEntity[size];
        }
    };
