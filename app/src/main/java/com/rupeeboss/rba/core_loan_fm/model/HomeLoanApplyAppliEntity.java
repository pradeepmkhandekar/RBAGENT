...
public  class HomeLoanApplyAppliEntity {
        /**
         * Aadhar_Card_No : null
         * Address1 :
         ...
         * Nationality : INDIAN
         * Nature_Of_Business : Select
         * Nature_Of_Employer : Salaried
         * Nature_Of_Organization : Select
         * Net_Income :
         * No_Of_Dependent :
         * Ofc_Email_Id :
         * Organize_City :
         * Organize_Country : India
         * Organize_LandlineNo :
