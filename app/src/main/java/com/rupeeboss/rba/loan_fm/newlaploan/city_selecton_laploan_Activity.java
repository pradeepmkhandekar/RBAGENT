...
public class city_selecton_laploan_Activity extends BaseActivity implements View.OnClickListener,IResponseSubcriberERP {
  ...
  //      databaseController = new DBPersistanceController(city_selecton_laploan_Activity.this);
   //     cityList = databaseController.getLoanCity();
        ...
        cvMUMBAI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(city_selecton_laploan_Activity.this, bank_selection_laploanActivity.class)
