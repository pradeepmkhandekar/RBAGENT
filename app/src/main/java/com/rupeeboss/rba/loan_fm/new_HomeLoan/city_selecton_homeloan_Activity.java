...
public class city_selecton_homeloan_Activity extends BaseActivity implements View.OnClickListener,IResponseSubcriberERP {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvMUMBAI.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(city_selecton_homeloan_Activity.this, bank_selection_homeloanActivity.class)
