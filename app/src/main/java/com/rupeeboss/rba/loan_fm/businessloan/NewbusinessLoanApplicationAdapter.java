package com.rupeeboss.rba.loan_fm.businessloan;
...
public class NewbusinessLoanApplicationAdapter extends RecyclerView.Adapter<NewbusinessLoanApplicationAdapter.ApplicationItem>implements Filterable {
    Activity mContext;
    List<NewLoanApplicationEnity> mApplicationList;


    public NewbusinessLoanApplicationAdapter(Activity context, List<NewLoanApplicationEnity> mApplicationList) {
            ...
            holder.lyParent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (entity.getRBStatus() != null) {
                        ...
                        ((NewbusinessApplicaionActivity) mContext).redirectbusinessLoanApply(entity);
...
//            });
            ...
            holder.ivLeadInfo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ((NewbusinessApplicaionActivity) mContext).openLeadDetailPopUp_business(entity.getLeadId());
                    }catch (Exception e) {
                        e.printStackTrace();
                    }
