...
import com.rupeeboss.rba.webviews.LAP.LAPLoanApplyActivity;
...
public class LAPQuoteActivity extends BaseActivity {

    HomeLoanRequest homeLoanRequest;
    GetQuoteResponse getQuoteResponse;
    Toolbar toolbar;
    RecyclerView rvQuotes;
    LAP_BankQuotesAdapter mAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.lap_activity_quote);
        initialise_widget();
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getQuoteResponse = getIntent().getParcelableExtra(Constants.QUOTES);
        mAdapter = new LAP_BankQuotesAdapter(LAPQuoteActivity.this, getQuoteResponse.getData());
...
//                String.valueOf(entity.getProcessingfee()));
        ...
        startActivity(new Intent(this, LAPLoanApplyActivity.class)
    ...
    private void initialise_widget() {
        ...
        rvQuotes.setLayoutManager(new LinearLayoutManager(LAPQuoteActivity.this));
...
//                        R.drawable.item_decor)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.btnMenuShare:
                boolean result = Utility.checkPermission(LAPQuoteActivity.this);
                if (result) {
                    shareData();
            ...
            case R.id.btnAddLead:
                startActivity(new Intent(LAPQuoteActivity.this, RbAddLeadActivity.class)
    ...
    private void datashareList(Bitmap bitmap, String strSubject, String strDetail) {
        ...
        try {
            ...
            PackageManager pm = LAPQuoteActivity.this.getPackageManager();
